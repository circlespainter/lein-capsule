...
(def ^:internal path-dependencies-allow-snapshots [:dependencies :allow-snapshots])
(def ^:internal path-dependencies-repositories [:dependencies :repositories])
(def ^:internal path-dependencies-artifacts-jvm [:dependencies :artifacts :jvm])
(def ^:internal path-dependencies-artifacts-native-mac [:dependencies :artifacts :native :mac])
(def ^:internal path-dependencies-artifacts-native-linux [:dependencies :artifacts :native :linux])
(def ^:internal path-dependencies-artifacts-native-windows [:dependencies :artifacts :native :windows])
